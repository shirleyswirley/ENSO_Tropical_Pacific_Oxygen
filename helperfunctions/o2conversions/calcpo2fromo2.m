function po2 = calcpo2(o2,sal,pottemp,depth)

%----------------------------------------------------
% Calculate pO2 from depth (pressure), salinity, temperature
%----------------------------------------------------
% Vars needed are: o2, sal, pottemp, depth
% o2 units are ml l^-1 
% pottemp units are deg C
% sal units are PSU
% depth units are m
